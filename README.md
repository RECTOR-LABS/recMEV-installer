...
- `recmev-v0.3.5-mac`: macOS binary
- `recmev-v0.3.5-linux`: Linux binary
...
```bash
sh -c "$(curl -sSfL https://raw.githubusercontent.com/RECTOR-LABS/recMEV-installer/v0.3.5/install.sh)"
```
...
curl -fsSL https://raw.githubusercontent.com/RECTOR-LABS/recMEV-installer/v0.3.5/recmev-v0.3.5-OS -o recmev
