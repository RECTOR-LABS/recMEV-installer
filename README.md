...
- `recmev-v0.5.0-mac`: macOS binary
- `recmev-v0.5.0-linux`: Linux binary
...
curl -fsSL https://raw.githubusercontent.com/RECTOR-LABS/recMEV-installer/v0.5.0/recmev-v0.5.0-OS -o recmev
