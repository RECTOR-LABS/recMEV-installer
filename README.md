...
- `recmev-v0.17.15-mac`: macOS binary
- `recmev-v0.17.15-linux`: Linux binary
...
- v0.17.15 (latest) - Enhanced uninstall command, improved logs with filtering options, and rate-limited transaction history
