...
- `recmev-v0.2.0-mac`: macOS binary
- `recmev-v0.2.0-linux`: Linux binary
...
```bash
sh -c "$(curl -sSfL https://raw.githubusercontent.com/RECTOR-LABS/recMEV-installer/v0.2.0/install.sh)"
```
...
curl -fsSL https://raw.githubusercontent.com/RECTOR-LABS/recMEV-installer/v0.2.0/recmev-v0.2.0-OS -o recmev
